...
app = Flask(__name__)
# Update the URI construction
username = quote_plus("rohanreddyus")
password = quote_plus("R@123456")
uri = f"mongodb+srv://{username}:{password}@cluster0.6ob9l.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
